                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-semibold text-sm">(+84) 123 456 789</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-secondary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      ...
                      <p className="text-white font-semibold text-sm">captain@passport.cafe</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-secondary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      ...
                      <p className="text-white font-semibold text-sm">TP. Hồ Chí Minh</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="border-t border-white/10 pt-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-6 text-xs text-white/50">
                  <a href="#" className="hover:text-secondary transition-colors">Điều khoản</a>
                  <a href="#" className="hover:text-secondary transition-colors">Chính sách</a>
