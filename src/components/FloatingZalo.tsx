  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 animate-slide-up">
      <div className="relative" onMouseEnter={() => setShowTooltip(true)} onMouseLeave={() => setShowTooltip(false)}>
        {/* Tooltip */}
        <div
          className={`absolute -top-20 md:-top-24 right-0 glass-effect px-6 md:px-8 py-3 md:py-4 rounded-2xl shadow-float whitespace-nowrap border border-white/10 transition-all duration-300 ${showTooltip ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2 pointer-events-none"}`}
        >
